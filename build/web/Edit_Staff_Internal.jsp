    ...
    <section class="confiq">
        ...
        <section id="sidebar">
            ...
            <c:forEach var="dr_type" items="${drType}">
               ...
               <li class="active">
                    <a href="getListStaffInternal"  id="showStaff" >
                        <i class='bx bxs-doughnut-chart'></i>
        ...
        <section id="content">
            ...
            <div class="dark_bg active">
                ...
                <div class="popup active" >
                    ...
                    <div class="body">
                        <form action="editStaffInternal" id="myForm" method="get">
                            <div class="imgholder">
                            ...
                            <div class="form_control">
                               ...
                               <input value="${detail.account.fistName}" type="text" name="fistName" id="fName" required>
                            </div>
                            <div class="form_control">
                                <label for="lastName">Last Name:</label>
                                <input value="${detail.account.lastName}" type="text" name="lastName" id="lName" required>
                            </div>
                        </div>
                        <div class="identify">
                            <div class="form_control">
                            ...
                            <div class="location">
                                ...
                                <input value="${detail.post_office.post_office_id}" name="post_OfficeID" type="text" id="post_OfficeID" required>
                                </div>
                            </div>
                        ...
                        <div class="form_control">
                            ...
                            <input value="${detail.account.phone_numb}" type="number" name="phone_numb" id="phone" required>
                        </div>
                            </div>
                        </form>
                    </div>
