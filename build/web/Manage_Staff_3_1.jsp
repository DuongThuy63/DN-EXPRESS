        ...
        <section id="content">
            ...
            <div class="dark_bg active">
                ...
                <div class="popup active" >
                    <header>
                        <h2 class="modalTitle">Edit Successful!</h2>
                       
                    </header>

                    <div class="body">
                        <form id="myForm">
                             <p>The driver information has been successfully updated.</p>
                        </form>
                    </div>
                    ...
                    <footer class="popupFooter">
                        <button form="myForm" class="submitBtn" onclick="window.location.href = 'Manage_Staff.jsp';" >Staff List</button>
                    </footer>
                </div>
            </div>
