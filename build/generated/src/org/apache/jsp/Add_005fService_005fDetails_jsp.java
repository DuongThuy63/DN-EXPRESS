...
public final class Add_005fService_005fDetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <!-- My CSS -->\n");
      out.write("    <link href=\"Manage_Staff_3.css\" rel=\"stylesheet\" type=\"text/css\"/>\n");
      ...
      out.write("                <a href=\"#\" class=\"nav-link\"><strong>Manage Service</strong></a>\n");
      ...
      out.write("                    <header>\n");
      out.write("                <h2 class=\"modalTitle\">View Service</h2>\n");
      out.write("                \n");
      out.write("            </header>\n");
      out.write("                    \n");
      out.write("            <div class=\"body\">  \n");
      out.write("                <div id=\"error-message\" class=\"error\" style=\"margin-left: 5%;\"></div>\n");
      out.write("                \n");
      out.write("                <form action=\"addService\" id=\"myForm\" method=\"post\"  onsubmit=\"validateForm(event);\">\n");
      out.write("                    \n");
      out.write("                    <div class=\"inputFieldContainer\">\n");
      out.write("                        \n");
      out.write("                         <div class=\"form_control\">\n");
      out.write("                                <label for=\"serName\">Service Type Name:</label>\n");
      out.write("                                <input type=\"text\" name=\"serName\" id=\"serName\" required>\n");
      out.write("                            </div>\n");
      out.write("\n");
      out.write("                            <!-- Thông tin Service Property -->\n");
      out.write("                                <div id=\"serviceProperties\">\n");
      out.write("                                    <div class=\"nameField\">\n");
      out.write("                                        <div class=\"form_control\">\n");
      out.write("                                            <label for=\"proName1\">Service Property Name:</label>\n");
      out.write("                                            <input type=\"text\" name=\"proName\" required>\n");
      out.write("                                        </div>\n");
      out.write("                                        <div class=\"form_control\">\n");
      out.write("                                            <label for=\"proPrice1\">Service Property Price:</label>\n");
      out.write("                                            <input type=\"text\" name=\"proPrice\"  oninput=\"clearErrorMessage();\"  required>\n");
      out.write("                                        </div>\n");
      out.write("                                    </div>\n");
      out.write("                                </div>\n");
      out.write("\n");
      out.write("                                <button type=\"button\" onclick=\"addProperty()\">Add Another Property</button>\n");
      out.write("\n");
      out.write("                                    \n");
      out.write("                       \n");
      out.write("                    </div>\n");
      ...
      out.write("    \n");
      out.write("    <script>\n");
      out.write("        let propertyCount = 1;\n");
      out.write("\n");
      out.write("        function addProperty() {\n");
      out.write("            propertyCount++;\n");
      out.write("            const div = document.createElement('div');\n");
      out.write("            div.className = 'property';\n");
      out.write("            div.innerHTML = `\n");
      out.write("             <div class=\"nameField\">\n");
      out.write("                <div class=\"form_control\">\n");
      out.write("                    <label for=\"proName");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${propertyCount}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">Service Property Name:</label>\n");
      out.write("                    <input type=\"text\" name=\"proName\" required> \n");
      out.write("                </div>\n");
      out.write("                <div class=\"form_control\">\n");
      out.write("                    <label for=\"proPrice");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${propertyCount}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">Service Property Price:</label>\n");
      out.write("                    <input type=\"text\" name=\"proPrice\" required>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("            `;\n");
      out.write("            document.getElementById('serviceProperties').appendChild(div);\n");
      out.write("        }\n");
      out.write("    </script>\n");
      out.write("    \n");
      out.write("       <script>\n");
      ...
      out.write("\n");
      out.write("            let propertyPrices = document.getElementsByName(\"proPrice\");\n");
      out.write("            for (let i = 0; i < propertyPrices.length; i++) {\n");
      out.write("                let price = propertyPrices[i].value;\n");
      out.write("                if (isNaN(price) || price.trim() === \"\") {\n");
      out.write("                    isValid = false;\n");
      out.write("                    errorMessage = \"Invalid price for property \" + (i + 1) + \": \" + price;\n");
      out.write("                    document.getElementById(\"error-message\").innerText = errorMessage;\n");
      out.write("                    propertyPrices[i].focus();\n");
      out.write("                    propertyPrices[i].value = \"\";\n");
      out.write("                    break;\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("\n");
      ...
      out.write("        }\n");
      out.write("\n");
      out.write("        function clearErrorMessage() {\n");
      out.write("            document.getElementById(\"error-message\").innerText = \"\";\n");
      out.write("        }\n");
      out.write("    </script>\n");
      out.write("</body>\n");
      out.write("\n");
