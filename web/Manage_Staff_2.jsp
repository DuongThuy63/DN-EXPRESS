...
<html>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="Manage_Staff_1.css">
    ...
    <body>
       <section class="confiq">
        ...
        <div class="popup" id="editPopup">
            ...
            <div class="body">
                <form action="editStaff" id="myForm">
                    <div class="imgholder">
                       ...
                       <div class="inputFieldContainer">
                        ...
                        <div class="identify">
                            <div class="form_control">
                                ...
                                <input type="text" name="account_id" id="account_id" readonly required>
                            </div>
                            <div class="form_control">
                        ...
                        <div class="location">
                            <div class="form_control">
                                ...
                                <input type="text" name="driver_typeID" id="driver_typeID" required>
                            </div>
                            <div class="form_control">
                                <label for="driver_typeName">Type Name:</label>
                                <input type="text" name="driver_typeName" id="driver_typeName" required>
                            </div>
                        </div>
                        <div class="form_control">
            ...
            <footer class="popupFooter">
                <button form="myForm" class="submitBtn" value="Edit">Submit</button>
            </footer>
        </div>
    </div>
