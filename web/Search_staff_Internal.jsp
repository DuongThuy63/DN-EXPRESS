                    ...
                    <table>
                        ...
                        <tbody>
                         ...
                         <c:forEach var="searchStaff" items="${searchResult}" varStatus="loop">
                                <tr>
                                    <td>${loop.index + 1}</td>
                                    <td>${searchStaff.account.getFistName()} ${searchStaff.account.getLastName()}</td>
                                    ...
                                    <td>
                                       ...
                                       <button class="action-btn edit-btn" 
                                         onclick="window.location.href='editStaffInternalDetails?account_id=${searchStaff.account.getAccount_id()}'">
